...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        <label for="txtNumber">Digite um número:</label>
        <asp:TextBox ID="txtNumber" runat="server" CssClass="form-control" MaxLength="10"></asp:TextBox>
    </div>
    <div class="mt-3">
        <asp:Button ID="btnCheckPalindrome" runat="server" Text="Verificar" CssClass="btn btn-primary" OnClick="btnCheckPalindrome_Click" />
    </div>
    <div class="mt-4">
